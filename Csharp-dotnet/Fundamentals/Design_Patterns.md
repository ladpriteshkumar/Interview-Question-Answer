...
- The Repository pattern is not one of the Gang of Four patterns. It’s an architectural/domain pattern (popularized by Domain‑Driven Design) that abstracts persistence, not a GoF creational/structural/behavioral pattern.
